package com.github.whatasame.springdatajpa.pessimisticlock;
...
import com.github.whatasame.springdatajpa.pessimisticlock.service.CountService;
...
@SpringBootTest
@DisplayName("동시성 테스트: Count")
class CountConcurrencyTest {
    ...
    void occurConcurrencyProblem() throws Exception {
        ...
        assertThat(updated.getCount()).isNotEqualTo(THREAD_COUNT * CLICK_COUNT);

        final long endTime = System.currentTimeMillis();
        System.out.println("테스트 시간: " + (endTime - startTime) + "ms");
        System.out.println("총 카운트 수: " + updated.getCount());
    }
    ...
    void resolveConcurrencyProblemWithPessimisticRead() throws Exception {
        ...
        /* then */
        final Count updated = countRepository.findById(original.getId()).get();
        assertThat(updated.getCount()).isEqualTo(THREAD_COUNT * CLICK_COUNT);
